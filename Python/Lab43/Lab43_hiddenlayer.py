# -*- coding: utf-8 -*-
"""
Created on Mon Dec 10 11:05:15 2018
히든레이어 구성한 후 학습 예시
@author: SDEDU
"""
...
def main():
    ...
    #일반저긍로 마지막 출력층은activation Function을 적용하지 않는다
    ...
    optimizer=tf.train.AdamOptimizer(0.01) #최적화
    ...
    for step in range(5001):
        ...
        if(step%100 ==0 or (step<100 and step%10==0)):
            print('step=%5d, Loss=%f' %(step,sess.run(loss,feed_dict=feed_dict)))
